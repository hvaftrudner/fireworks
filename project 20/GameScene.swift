...
//  project 20
//
//  Created by Kristoffer Eriksson on 2020-10-29.
//
...
class GameScene: SKScene {
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if launchCount == 6{
            ...
            endLabel.text = "GAME OVER Endscore = \(score)"
            endLabel.position = CGPoint(x: 512, y: 384)
